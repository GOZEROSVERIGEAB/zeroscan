        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-[#005151] text-white flex flex-col fixed inset-y-0 left-0 z-30">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1">
                    ...
                    <a href="{{ route('admin.environmental-review') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition {{ request()->routeIs('admin.environmental-review') ? 'bg-white/15 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        </svg>
                        <span class="font-medium">Miljödata</span>
                    </a>
