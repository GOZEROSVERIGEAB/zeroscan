                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                <div class="flex items-start gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-[#005151] flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
                                <div class="text-center">
                                    <p class="text-2xl font-bold text-gray-900">{{ number_format($station->total_scans ?? 0) }}</p>
                                    <p class="text-xs text-gray-500">{{ __('scanit.stations.total_scans') }}</p>
                                </div>
                                <div class="text-center">
                                    <p class="text-2xl font-bold text-gray-900">{{ number_format($station->total_items ?? 0) }}</p>
                                    <p class="text-xs text-gray-500">{{ __('scanit.stations.total_items') }}</p>
                                </div>
                                <div class="text-center">
                                    <p class="text-2xl font-bold text-gray-900">{{ number_format($station->total_co2_savings ?? 0, 1) }}</p>
        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" wire:click.self="cancelDelete">
            <div class="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-xl">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">{{ __('scanit.stations.delete') }}</h3>
                        <p class="text-sm text-gray-500">{{ $stationToDelete?->name }}</p>
                    </div>
                </div>
                <p class="text-gray-600 mb-6">{{ __('scanit.stations.delete_confirm') }}</p>
                <div class="flex gap-3">
                    ...
                    <button wire:click="deleteStation" class="flex-1 px-4 py-2.5 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-colors">
